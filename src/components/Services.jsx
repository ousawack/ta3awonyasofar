    ...
    <div className="px-4 py-20 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          ...
          marketplace ensures the following services
        </h2>
      ...
      <div className="grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Service 1</h6>
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Service 2</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Service 3</h6>
            <p className="mb-3 text-sm text-gray-900">
        ...
        <div className="flex flex-col justify-between p-5 border rounded shadow-sm">
          <div>
            ...
            <h6 className="mb-2 font-semibold leading-5">Service 4</h6>
            <p className="mb-3 text-sm text-gray-900">
